module Datapath #(parameter N=8) (
    ...
    wire w_Reg_WE;
    wire [3:0] w_Ula_op;
    wire w_Branch_Eq, w_Branch_NEq, w_Branch_BEq, w_Branch_Final;
    wire [1:0] w_Mux_Sel;
    wire w_Mem_WE;
    wire w_Zero_Flag;
    wire w_Halt;
    ...
    assign w_RAM_IO_Bus = (w_Mem_WE) ? w_Data_RD : {N{1'bz}};
    assign i_RAM_Data = w_RAM_IO_Bus;
    assign o_Result = w_Ula_Result;
    assign o_RAM_Addr = w_Ula_Result;
    assign w_PC_Next = (w_Branch_Final) ? w_Immediate : (w_PC_Current + 1'b1);
